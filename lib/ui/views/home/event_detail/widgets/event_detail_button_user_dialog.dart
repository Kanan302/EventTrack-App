...
class EventDetailButtonUserDialog extends StatelessWidget {
  final VoidCallback onConfirm;

  const EventDetailButtonUserDialog({super.key, required this.onConfirm});
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      title: Text(
        AppLocalizations.of(context).registerEvent,
